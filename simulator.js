function runSim(gearTable, baseLine, makeBaseLine) {
  ...
  for (var q=1; q<=7; q++) {
    ...
    for (var i=0; i<timeVec.length; i++) {
      var doom = false, agony = false, corruption = false, immolate = false, siphon = false, time = threatTime, damage = 0, mana = manaMain, timePast = 0, SBC = 0, trinket1Time = 0, trinket2Time, trinket1CD = 0, trinket2CD = 0, trinket1Bonus = false, trinket2Bonus = false, piTime = 0, piCD = 0, ZHCStacks = 0;
      if (useDoom == true)
        var doomUse = 0;
      else {
