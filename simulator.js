function runSim() {
  ...
  var dpsChart = new Chart(document.getElementById('dpsChart'), {
    ...
    options: {
      scales: {xAxes: [{ticks: {autoSkipPadding: 2}, scaleLabel: {display: true, labelString: "Fight Duration"}}], yAxes: [{ticks: {beginAtZero: true, max: 1600}, scaleLabel: {display: true, labelString: "DPS"}}] },
